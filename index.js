...
//Q2
let names10 = "Emaan";
let message = `Hello, ${names10}, would you like to learn some typescript today?`;
console.log(message);
//Q3 
let names = "Wania";
...
console.log(result);
//Q5
let famous_name = "Mark Twain";
let author2 = "The secret of getting ahead is getting started.";
let message2 = `Once ${famous_name} said, ${author2}`;
console.log(message2);
//Q6
let name5 = "   Aimal   ";
console.log(name5);
let trimmedName = name5.trim();
...
let famous_name1 = "Mark Twain";
//Here i declare a variable and store a value in it
let author3332 = "The secret of getting ahead is getting started.";
//here i declare a variable and i concat the variables values
let message22 = `Once ${famous_name1} said, ${author3332}`;
...
//Q12
let names2 = ["Alice", "Bob", "Charlie", "David"];
...
//Q16
let names4 = ["Aimal", , "Shanzay", "Dania"];
...
let guestList1 = ["Aimal", "Maria", "wanaia"];
...
//Q17
let guestList10 = ["Aimal", "Maria", "wanaia"];
...
//Q34
let pizza = ["Pepperoni", "Margherita", "BBQ Chicken"];
...
//Q35
let climbingAnimals = ['Monkey', 'Squirrel', 'Gecko'];
...
//Q42
let magicians1 = ["Harry Houdini", "David Copperfield", "Penn Jillette", "Teller", "Dynamo"];
function makeGreat(magiciansList) {
    for (let i = 0; i < magiciansList.length; i++) {
        magiciansList[i] = "the Great " + magiciansList[i];
    }
}
function showMagicians1(magiciansList) {
    for (let i = 0; i < magiciansList.length; i++) {
        console.log(magiciansList[i]);
    }
}
...
//Q43
let magicians10 = ["Harry Houdini", "David Copperfield", "Penn Jillette", "Teller", "Dynamo"];
function makeGreat1(magiciansList) {
    return magiciansList.map(magicians => "the Great " + magicians);
}
function showMagicians10(magiciansList) {
